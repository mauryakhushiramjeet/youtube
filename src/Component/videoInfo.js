...
const VideoInfo = ({ videoInfo }) => {
  ...
  return (
    <div className="flex  sm:flex-row justify-between flex-col">
      <div className="flex  pt-1 sm:py-2 items-center gap-3">
        <img
          className="cursor-pointer object-cover rounded-full mx-0 h-12 w-12 ml-2 "
          src={
        ...
        <button
          ...
          className="py-1 flex items-center  text-white justify-center gap-1 px-4 m-2 font-semibold bg-black rounded-full"
        >
          {isSubscribed ? (
            <>
      ...
      <div className="flex items-center  sm:py-2  gap-3 sm:justify-center">
        <div className="flex text-white bg-black m-2 rounded-full  ">
          <button
            onClick={handleLike}
